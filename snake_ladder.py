#
# CLI-based snake and ladder game
#
...
# just for effects added a delay of 1 second before performing any action
...
def welcome_msg():
    ...
    Rules:
      1. Initially both the players are at starting position i.e. 0 and whoever rolls the dice with highest number starts. 
